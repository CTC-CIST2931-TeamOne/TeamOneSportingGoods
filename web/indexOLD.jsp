...
<%  
    ...
    //**************************************************************************
    // custObject: get/set session (contains orderList,cartList,paymentMethodList)
    //**************************************************************************
    
    boolean firstTimeRun = true;

    Customer custObject = new Customer();   // create empty custObject

    // test for firstTimeRun.               // create new session object if so
    if ((session.getAttribute("firstTimeRun")) == null){
        firstTimeRun = false;
        session.setAttribute("firstTimeRun",firstTimeRun);
        session.setAttribute("custObject",custObject); 
    } else {                                // else use existing custObject
        custObject = (Customer)session.getAttribute("custObject");
    }
    
    //**************************************************************************
    // allProducts : set session (contains all products)
    //**************************************************************************
    LoadProductTable allProducts = new LoadProductTable();
    allProducts.memLoadProducts();          // Load productList with full Table
    
    allProducts.copyList(allProducts.productList);
    
                                            // set allProducts Object in session
            ...
            <div id="myModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <form name="LoginForm" method="post" id="LoginForm" action="http://localhost:8080/TeamOneSports/LoginServlet">
                        <input class="margin box" onkeydown="nospace(event)" type=text placeholder="Username" name="user" id="user" />
                        <br />
...
<!---------------------- The Banner ------------------------------------------->
    <div class="top_banner">
        <div class="left_banner">
            <a href="">
                $1 SHIPPING ON EVERY ITEM, NO MATTER THE WEIGHT
            </a>
            <p>
                #Death2Amazon
            </p>
        ...
        <div class="right_banner">
            ...
            <p>
                hours are posted in Covid FAQ at the bottom of this page
            </p>
        </div>
    </div>
<!---------------------- The Carousel ------------------------------------------->
            ...
            <!-- looping add on the top of page
                ...
                <center class="image-slider">
                    <div class="slider-container">
                        <div class="c_image">
                            <img class="image" src="carousel_images/sports.jpg" alt="" onclick='window.open("#","_top")'>
                        </div>

                        <div class="c_image">
                            <img class="image"  src="carousel_images/soccer.jpg" alt="" onclick='window.open("#","_top")'>
                        </div>

                        <div class="c_image">
                            <img class="image"  src="carousel_images/baseball.jpg" alt="" onclick='window.open("#","_top")'>
                        </div>

                        <div class="c_image">
                            <img class="image"  src="carousel_images/basketball.jpg" alt="" onclick='window.open("#","_top")'>
                        </div>

                        <div class="c_image">
                            <img class="image"  src="carousel_images/football.jpg" alt="" onclick='window.open("#","_top")'>
                        </div>
...
<!---------------------- Sale Banner--------------------------------------->
        ...
        <div class="sale_container">
            <div class="sale_banner">
                <p style="font-size: 50px; color: #494949;">20% ALL JERSEYS AND TEAM SHIRTS!</p>
                <p style="font-size: 24px; color: #494949;"> represent your team on game day!</p>
            </div>
        </div>
    </div>	
<!--------------------Direct Links to Sports----------------------------------->
    ...
    <div class="header">
        <div class="sale_container">
            <div class="offer">
                <div class="row">
                    <div class="column">
                        <img src="images/imageexclusive.png" class="exclusive_image">
                    </div>
                    <div class="column">
                        ...
                        <h1>
                            Shoulderpads from Xenith, Riddell, and more!
                        </h1>
                        <small>
