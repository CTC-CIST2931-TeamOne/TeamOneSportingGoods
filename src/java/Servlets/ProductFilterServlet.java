...
public class ProductFilterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("*************************** IN ProductsFilterServlet *******************");
        ...
        try {
            ...
            Customer custObject;                // Get custObject from ssession
            ...
            //Sets ProductFilter in session from select form
            //if(request.getParameter("submit") != null){
                
                productFilter = request.getParameter("filter");
