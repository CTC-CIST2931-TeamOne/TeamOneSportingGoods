...
function address1Invalid(){
    ...
    address1.setCustomValidity("Please input your address"); // custom validity
...
function phoneInvalid(){
    ...
    // Set title
    document.getElementById("phone").title = "Please input a phone number";    
...
function registerCheck(){
    ...
    phone.oninvalid = function() {phone1Invalid();};
    ...
    // address1
    if (address1.value === ""){
        var address1 = document.getElementById("address1"); // address var
...
function expDateValid(){
    // Time Chosen
    var cardDate = document.getElementById("expDate").value;
    // For style
    ...
    // Format the date to be MM/YY
    var mm_yy = (today.getMonth()+1)+'/'+today.getFullYear().toString().substr(-2);
    
    // If cardDate is expired
    if (cardDate < mm_yy){
    
        date.style.border = "2px solid red"; // Change border color
        date.setCustomValidity("Your card is Expired"); // custom validity

        document.getElementById("expDate").title = "Your card is expired"; // Set title

        return false;
    }
    else if (cardDate > mm_yy){
        
        date.style.border = "1px solid black"; // Change border color
        date.setCustomValidity(""); // custom validity

        document.getElementById("expDate").title = "Format should be MM/YY"; // Set title
...
function addressInvalid(){
    ...
    address.setCustomValidity('Please enter a valid last name : No digits'); // set validity
...
function cityInvalid(){
    ...
    city.setCustomValidity('Please enter your address : not required : No special characters'); // set validity
...
function zipInvalid(){
    ...
    zip.setCustomValidity('Please enter a valid state Abbrev : No special digits'); // set validity
